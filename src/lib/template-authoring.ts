...
// Preis-Tabellen brauchen spürbar horizontalen Abstand zwischen den Spalten, sonst wirkt das Layout gequetscht.
const defaultCopy = {
  docTitle: "Angebot",
...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    th { text-align: left; font-size: 11px; text-transform: uppercase; letter-spacing: 0.14em; color: var(--muted); padding: 0 16px 10px; border-bottom: 1px solid var(--line); }
    td { padding: 14px 16px; border-bottom: 1px solid var(--line); vertical-align: top; }
    th:first-child, td:first-child { padding-left: 0; }
    th:last-child, td:last-child { padding-right: 0; }
    .num { text-align: right; white-space: nowrap; padding-left: 28px; }
